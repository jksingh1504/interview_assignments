...
const doc = {
  ...
  tags: [
    ...
    { name: "Admin Authentication" },
    {
      name: "User",
      description:
        "Before the api call it checked if user cookie token (userToken) is present or not. and user fetched from the id decoded from token.",
    },
    {
      name: "User Address",
      description:
        "Before the api call it checked if user cookie token (userToken) is present or not. and address fetched from the id of user decoded from token.",
    },
    { name: "Products" },
    {
      name: "User Cart",
      description:
        "Before the api call it checked if user cookie token (userToken) is present or not. and cart fetched from the id of user decoded from token.",
    },
